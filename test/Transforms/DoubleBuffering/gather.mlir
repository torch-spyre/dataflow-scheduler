...
// CHECK-NEXT:            ktdf.data_transfer from %[[SEL]][%[[C0]]] size [64] to %[[DST]][%[[C0]]] size [64] : memref<64xf16, #ktdp.memory_space<ct_local>>, memref<64xf16, #ktdp.memory_space<global>>
// CHECK-NEXT:          }
// CHECK-NEXT:        }
// CHECK-NEXT:      }
...
func.func @gather(%src: memref<64xf16, #ktdp.memory_space<global>>,
                  %dst: memref<64xf16, #ktdp.memory_space<global>>,
                  %iab: memref<32xindex, #ktdp.memory_space<ct_local>>) {
