...
// CHECK-LABEL:   func.func @alloc_multi_use(
...
// CHECK-NEXT:            "test.touch"(%[[ALLOC]]) : (memref<64xf16, "L1">) -> ()
...
func.func @alloc_multi_use(%src: memref<64xf16, "DDR">,
